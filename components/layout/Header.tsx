...
export default function Header() {
  ...
  return (
    <>
      {/* Top Bar */}
      <div className="bg-gradient-to-r from-primary-500 to-secondary-500 text-white py-2 text-sm">
        <div className="container-custom flex items-center justify-between">
          ...
          <div className="flex items-center justify-center flex-1 sm:flex-none">
            ...
            >
              <Percent className="w-4 h-4 animate-pulse" />
          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <Link href="/" className="flex items-center gap-2">
              ...
              >
                ...
                <span className="font-heading font-bold text-2xl md:text-3xl gradient-text">
                  BowPaw
                </span>
              </motion.div>
            </Link>
            ...
            <div className="flex items-center gap-1 md:gap-2">
              ...
              >
                ...
                <span className="absolute -bottom-8 left-1/2 -translate-x-1/2 bg-dark text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                  Search
                </span>
              </motion.button>
              ...
              <Link href={isAuthenticated ? '/account' : '/login'}>
                ...
                >
                  {isAuthenticated && currentUser ? (
                    <div className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-primary-500 text-white text-xs font-bold flex items-center justify-center">
              ...
              >
                ...
                {cartCount > 0 && (
                  <motion.span
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    className="absolute -top-0.5 -right-0.5 w-5 h-5 bg-primary-500 text-white text-xs 
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute top-0 left-0 bottom-0 w-[85%] max-w-sm bg-white overflow-y-auto shadow-2xl"
            >
              <div className="p-4 pb-8">
                <div className="flex items-center justify-between mb-6 sticky top-0 bg-white py-2 -mx-4 px-4 z-10">
                  <Link href="/" onClick={closeMobileMenu} className="flex items-center gap-2">
                    <span className="text-2xl">🐾</span>
                    <span className="font-heading font-bold text-xl gradient-text">BowPaw</span>
                  </Link>
                  <motion.button
                    whileTap={{ scale: 0.9 }}
                    onClick={closeMobileMenu}
                ...
                <div className="mt-8 pt-6 border-t space-y-2">
                  <Link
                    href="/account"
                    onClick={closeMobileMenu}
                    className="flex items-center gap-3 px-4 py-3 font-medium hover:bg-gray-100 rounded-xl active:scale-95 transition-all"
                  >
                    <div className="w-10 h-10 bg-primary-100 rounded-xl flex items-center justify-center">
                      <User className="w-5 h-5 text-primary-500" />
                    </div>
                    <div>
                      <span className="block text-dark">My Account</span>
                  ...
                  >
                    ...
                    <div>
                      <span className="block text-dark">Call Us</span>
                ...
                <div className="mt-6 p-4 bg-gradient-to-r from-primary-50 to-secondary-50 rounded-2xl">
                  <p className="text-sm font-semibold text-dark mb-3">Quick Services</p>
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      <Link
                        ...
                        href={service.href}
                        onClick={closeMobileMenu}
                        className="flex flex-col items-center gap-1 p-3 bg-white rounded-xl hover:shadow-md transition-all active:scale-95"
                      >
